...
const ServiceCard = ({ service, index }) => {
  return (
    <div
      ...
      {/* Index Number */}
      <div className="absolute right-4 top-4 z-10 text-8xl font-black text-secondary/20">
        0{index + 1}
      </div>
      ...
      <div className="p-6 transition-all duration-300 group-hover:bg-primary-dark">
        ...
        <p className="mb-5 line-clamp-3 text-gray-300">
          {service.description}
        </p>
        ...
        <div className="flex justify-end">
          <Link
            ...
            className="flex items-center gap-2 rounded-full bg-secondary px-6 py-3 font-medium text-primary transition-all duration-300 hover:bg-secondary-dark hover:shadow-lg hover:shadow-secondary/30"
          >
            Discover More
