  ...
  return (
    <div
      ...
      <div className="relative h-full flex flex-col justify-end p-6 text-white">
        ...
        {/* Title */}
        <h3
          className="text-2xl font-bold mb-2 leading-tight transition-all duration-300 group-hover:translate-y-[-5px]">
          {title}
        </h3>
        ...
        <div
          ...
          <div className="flex flex-col items-start gap-2">
            <div>
              <span className="text-md font-bold italic text-gray-500">author</span>
            </div>
          ...
          <Link
            to={`/blog/${id}`}
            className="flex items-center gap-2 px-4 py-2 bg-secondary backdrop-blur-sm rounded-full transition-all duration-200"
          >
            Read Article
