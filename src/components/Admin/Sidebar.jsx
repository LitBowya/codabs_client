...
const Sidebar = () => {
    ...
    const navItems = [
        ...
        { path: '/admin/drivers', name: 'Drivers', icon: <FiUserCheck size={20} /> },
        { path: '/admin/riders', name: 'Riders', icon: <FiMap size={20} /> },
        { path: '/admin/payments', name: 'Payments', icon: <FiCreditCard size={20} /> },
    ];
                        ...
                        <div className={`flex ${collapsed ? 'flex-col items-center' : 'items-center'}`}>
                            <div className="relative">
                                {user?.profilePicture ? (
                                    ...
                                    <div className="w-12 h-12 rounded-full bg-primary-accent flex items-center justify-center border-2 border-white/30">
