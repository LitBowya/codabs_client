            ...
            >
                <div className="max-width sm:px-6 lg:px-12 pt-32 sm:pt-40 lg:pt-48 xl:pt-64">
                    <div className="space-y-4 lg:space-y-6">
                        {/* Brand Name */}
                        <div>
                            <h1 className="text-secondary text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold flex items-center gap-3">
                ...
                <span className="text-secondary">
                  {renderAnimatedText('Building with Purpose,', 'subtitle')}
                        ...
                        <p className="hero-paragraph text-white text-sm sm:text-base lg:text-lg mt-2 max-w-2xl leading-relaxed">
                            At <span className="text-secondary font-bold">Codabs Construction</span>, we don’t just build structures — we create
                            landmarks of trust, innovation, and lasting quality. Every detail matters, and every project reflects our passion
                            for excellence.
                        </p>
